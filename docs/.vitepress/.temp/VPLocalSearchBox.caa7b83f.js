import { ref, watch, defineComponent, shallowRef, computed, watchEffect, onMounted, nextTick, toRef, onBeforeUnmount, unref, markRaw, createApp, useSSRContext } from "vue";
...
import { b7 as unrefElement, b8 as tryOnScopeDispose, b9 as useData, ba as computedAsync, bb as useSessionStorage, bc as useLocalStorage, bd as watchDebounced, be as onKeyStroke, bf as useRouter, bg as reactify, bh as useEventListener, bi as useScrollLock, bj as dataSymbol, bk as pathToFile, bl as createTranslate, bm as inBrowser } from "./app.js";
import { _ as _export_sfc } from "./plugin-vue_export-helper.cc2b3d55.js";
import "element-plus";
import "@element-plus/icons-vue";
const localSearchIndex = { "root": () => import("./@localSearchIndexroot.3bc31609.js") };
/*!
* tabbable 6.2.0
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const $t = reactify(createTranslate)(
      toRef(() => {
        var _a3;
        return (_a3 = theme.value.search) == null ? void 0 : _a3.options;
      }),
      defaultTranslations
    );
    onMounted(() => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        var _a3, _b2, _c, _d;
        _push2(`<div role="button"${ssrRenderAttr("aria-owns", ((_a3 = results.value) == null ? void 0 : _a3.length) ? "localsearch-list" : void 0)} aria-expanded="true" aria-haspopup="listbox" aria-labelledby="localsearch-label" class="VPLocalSearchBox" data-v-3983edc2><div class="backdrop" data-v-3983edc2></div><div class="shell" data-v-3983edc2><form class="search-bar" data-v-3983edc2><label${ssrRenderAttr("title", buttonText.value)} id="localsearch-label" for="localsearch-input" data-v-3983edc2><svg class="search-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-3983edc2><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" data-v-3983edc2><circle cx="11" cy="11" r="8" data-v-3983edc2></circle><path d="m21 21l-4.35-4.35" data-v-3983edc2></path></g></svg></label><div class="search-actions before" data-v-3983edc2><button class="back-button"${ssrRenderAttr("title", unref($t)("modal.backButtonTitle"))} data-v-3983edc2><svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-3983edc2><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 12H5m7 7l-7-7l7-7" data-v-3983edc2></path></svg></button></div><input${ssrRenderAttr("value", unref(filterText))}${ssrRenderAttr("placeholder", buttonText.value)} id="localsearch-input" aria-labelledby="localsearch-label" class="search-input" data-v-3983edc2><div class="search-actions" data-v-3983edc2>`);
        if (!disableDetailedView.value) {
          _push2(`<button type="button" class="${ssrRenderClass([{ "detailed-list": unref(showDetailedList) }, "toggle-layout-button"])}"${ssrRenderAttr("title", unref($t)("modal.displayDetails"))} data-v-3983edc2><svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-3983edc2><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 14h7v7H3zM3 3h7v7H3zm11 1h7m-7 5h7m-7 6h7m-7 5h7" data-v-3983edc2></path></svg></button>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`<button class="clear-button" type="reset"${ssrIncludeBooleanAttr(disableReset.value) ? " disabled" : ""}${ssrRenderAttr("title", unref($t)("modal.resetButtonTitle"))} data-v-3983edc2><svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-3983edc2><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 5H9l-7 7l7 7h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2Zm-2 4l-6 6m0-6l6 6" data-v-3983edc2></path></svg></button></div></form><ul${ssrRenderAttr("id", ((_b2 = results.value) == null ? void 0 : _b2.length) ? "localsearch-list" : void 0)}${ssrRenderAttr("role", ((_c = results.value) == null ? void 0 : _c.length) ? "listbox" : void 0)}${ssrRenderAttr("aria-labelledby", ((_d = results.value) == null ? void 0 : _d.length) ? "localsearch-label" : void 0)} class="results" data-v-3983edc2><!--[-->`);
        ssrRenderList(results.value, (p, index) => {
          _push2(`<li role="option"${ssrRenderAttr("aria-selected", selectedIndex.value === index ? "true" : "false")} data-v-3983edc2><a${ssrRenderAttr("href", p.id)} class="${ssrRenderClass([{
            selected: selectedIndex.value === index
          }, "result"])}"${ssrRenderAttr("aria-label", [...p.titles, p.title].join(" > "))} data-v-3983edc2><div data-v-3983edc2><div class="titles" data-v-3983edc2><span class="title-icon" data-v-3983edc2>#</span><!--[-->`);
          ssrRenderList(p.titles, (t, index2) => {
            _push2(`<span class="title" data-v-3983edc2><span class="text" data-v-3983edc2>${t}</span><svg width="18" height="18" viewBox="0 0 24 24" data-v-3983edc2><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 18l6-6l-6-6" data-v-3983edc2></path></svg></span>`);
          });
          _push2(`<!--]--><span class="title main" data-v-3983edc2><span class="text" data-v-3983edc2>${p.title}</span></span></div>`);
          if (unref(showDetailedList)) {
            _push2(`<div class="excerpt-wrapper" data-v-3983edc2>`);
            if (p.text) {
              _push2(`<div class="excerpt" inert data-v-3983edc2><div class="vp-doc" data-v-3983edc2>${p.text}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="excerpt-gradient-bottom" data-v-3983edc2></div><div class="excerpt-gradient-top" data-v-3983edc2></div></div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></a></li>`);
        ...
        if (unref(filterText) && !results.value.length && enableNoResults.value) {
          _push2(`<li class="no-results" data-v-3983edc2>${ssrInterpolate(unref($t)("modal.noResultsText"))} &quot;<strong data-v-3983edc2>${ssrInterpolate(unref(filterText))}</strong>&quot; </li>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</ul><div class="search-keyboard-shortcuts" data-v-3983edc2><span data-v-3983edc2><kbd${ssrRenderAttr("aria-label", unref($t)("modal.footer.navigateUpKeyAriaLabel"))} data-v-3983edc2><svg width="14" height="14" viewBox="0 0 24 24" data-v-3983edc2><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19V5m-7 7l7-7l7 7" data-v-3983edc2></path></svg></kbd><kbd${ssrRenderAttr("aria-label", unref($t)("modal.footer.navigateDownKeyAriaLabel"))} data-v-3983edc2><svg width="14" height="14" viewBox="0 0 24 24" data-v-3983edc2><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v14m7-7l-7 7l-7-7" data-v-3983edc2></path></svg></kbd> ${ssrInterpolate(unref($t)("modal.footer.navigateText"))}</span><span data-v-3983edc2><kbd${ssrRenderAttr("aria-label", unref($t)("modal.footer.selectKeyAriaLabel"))} data-v-3983edc2><svg width="14" height="14" viewBox="0 0 24 24" data-v-3983edc2><g fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" data-v-3983edc2><path d="m9 10l-5 5l5 5" data-v-3983edc2></path><path d="M20 4v7a4 4 0 0 1-4 4H4" data-v-3983edc2></path></g></svg></kbd> ${ssrInterpolate(unref($t)("modal.footer.selectText"))}</span><span data-v-3983edc2><kbd${ssrRenderAttr("aria-label", unref($t)("modal.footer.closeKeyAriaLabel"))} data-v-3983edc2>esc</kbd> ${ssrInterpolate(unref($t)("modal.footer.closeText"))}</span></div></div></div>`);
      }, "body", false, _parent);
    };
  }
});
const VPLocalSearchBox_vue_vue_type_style_index_0_scoped_3983edc2_lang = "";
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/vitepress@1.0.0-rc.24_@algolia+client-search@4.22.1_axios@0.27.2_sass@1.70.0_search-insights@2.13.0/node_modules/vitepress/dist/client/theme-default/components/VPLocalSearchBox.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const VPLocalSearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3983edc2"]]);
export {
